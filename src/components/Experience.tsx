  ...
  return (
    <section id="experience" className="py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <span className="bg-indigo-500/10 text-indigo-400 text-sm font-semibold px-4 py-2 rounded-full">
            ✦ Our Panel
          </span>
          <h2 className="text-4xl sm:text-5xl font-bold text-white mt-4">
            Experience Our <span className="text-indigo-400">Platform</span>
          </h2>
              ...
              return (
                <button
                  ...
                  className={`relative w-full text-left p-5 rounded-xl border transition-all duration-300 ${
                    isActive ? 'bg-indigo-500/10 border-indigo-500' : 'bg-gray-800/50 border-gray-700 hover:bg-gray-800/80'
                  }`}
                >
                  {/* Animasi Loading Bar */}
                  {isActive && (
                  ...
                  <div className="flex items-start gap-4">
                    <div className={`p-2 rounded-md ${isActive ? 'text-indigo-400' : 'text-gray-400'}`}>
                      <Icon size={24} />
                    </div>
                    <div>
