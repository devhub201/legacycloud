          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            >
              <h2 className="text-4xl sm:text-5xl font-bold text-white leading-tight">
                Host your own
                <br />
                <span className="text-indigo-400 h-20 block">
              ...
              <div className="mt-8 flex items-center space-x-6">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="bg-indigo-500 text-white font-semibold px-6 py-3 rounded-lg flex items-center space-x-2 hover:bg-indigo-600 transition-colors"
                >
              ...
              {featureCards.map((card, index) => (
                ...
                >
                  <div className="flex items-start space-x-4">
                      <card.icon className="text-indigo-400 mt-1" size={24} />
                      <div>
