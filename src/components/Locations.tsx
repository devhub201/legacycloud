  ...
  return (
    <section id="locations" className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <span className="bg-indigo-500/20 text-indigo-300 text-sm font-semibold px-4 py-1 rounded-full inline-flex items-center gap-2">
            <Globe size={14}/>
            Global Infrastructure
          </span>
          <h2 className="text-4xl sm:text-5xl font-bold text-white mt-4">
            Global <span className="text-indigo-400">Locations</span>
          </h2>
          ...
          {serverLocations.map((loc) => (
            ...
            >
              <div className="relative flex justify-center items-center">
                <div className="absolute w-4 h-4 rounded-full bg-indigo-500 animate-ping opacity-75"></div>
