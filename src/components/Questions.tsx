                ...
                <div key={index} className="bg-gray-800/50 border border-gray-700 rounded-xl">
                  ...
                  >
                    <div className="flex items-center">
                        <span className="text-indigo-400 font-bold mr-4 bg-gray-700/50 px-3 py-1 rounded-md">
                            0{index + 1}
                        </span>
                        <span className="font-semibold text-white">{faq.question}</span>
                    </div>
                    <ChevronRight 
                        className={`transform transition-transform duration-300 text-indigo-400 ${activeIndex === index ? 'rotate-90' : 'rotate-0'}`}
                        size={20}
                    />
                  </button>
                  <AnimatePresence>
