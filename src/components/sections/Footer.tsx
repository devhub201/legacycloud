...
const cols = [
  { title: "Services", links: [["Minecraft", "/plans"], ["VPS", "/vps"], ["Services", "/services"]] },
  { title: "Company", links: [["About", "/about"], ["Status", "/status"], ["Terms", "/terms"]] },
  { title: "Support", links: [["Support", "/support"], ["Discord", "/discord"]] },
];
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
        <div className="col-span-2 md:col-span-1">
          ...
          <p className="text-sm text-muted-foreground mb-4">
            Ultra-fast hosting for gamers and developers.
          </p>
          <a
            href={DISCORD_INVITE}
            target="_blank"
