...
const REVIEWS = [
  { name: "Aarav S.", place: "Mumbai", text: "Shifted our 20-player SMP here. Zero lag spikes and support fixed a plugin conflict in minutes." },
  { name: "BlossomMia", place: "Australia", text: "The cherry blossom vibe sold me, the hardware kept me. Modpack loads faster than my old host." },
  { name: "Lucas F.", place: "Brazil", text: "VPS Premium runs my bots and panel together. Full root, snapshots, no downtime in 3 months." },
  { name: "xShadowPvP", place: "Germany", text: "PvP server with 30 players, TPS stays at 20. Frankfurt node ping is excellent." },
  { name: "Ryan P.", place: "Delhi", text: "₹15/GB pricing is unreal for this quality. Backups saved my world after a griefing incident." },
  { name: "NetherNico", place: "Netherlands", text: "Panel is clean, console is instant. Best budget host I've used, and I've used many." },
];
  ...
  return (
    <>
      <section className="max-w-6xl mx-auto px-6 pt-20 pb-24 text-center">
        ...
        >
          Hosting that blooms <br /> under <span className="text-gradient-blossom">cherry blossoms.</span>
        </motion.h1>
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 max-w-3xl mx-auto gap-4">
          {[
            ...
            <div key={s.l} className="glass rounded-2xl p-4 animate-float-slow">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          {FEATURES.map((f, i) => (
            <motion.div
              ...
              whileHover={{ y: -4 }}
              className="glass rounded-2xl p-6 hover:ring-glow-blossom transition-shadow"
            >
      ...
      <section className="max-w-6xl mx-auto px-6 pb-24">
        <div className="text-center mb-10">
          ...
          <p className="text-muted-foreground">A taste of our lineup — see all plans on the hosting pages.</p>
        </div>
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <PlanCard plan={MC_BUDGET.plans[1]} index={0} />
          <PlanCard plan={MC_BUDGET.plans[2]} index={1} />
          <PlanCard plan={VPS_BUDGET.plans[1]} index={2} />
          <PlanCard plan={VPS_BUDGET.plans[2]} index={3} />
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
          {REVIEWS.map((r, i) => (
            <motion.div
              ...
              viewport={{ once: true, amount: 0.2 }} transition={{ delay: i * 0.04 }}
              whileHover={{ y: -3 }} className="glass rounded-2xl p-6"
            >
